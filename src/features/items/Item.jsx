    ...
    if (item.name.toLowerCase().indexOf(search.toLowerCase()) > -1 ||
      ...
      return (
        <tr onClick={handleEdit} className="hover:bg-slate-200 text-xl dark:hover:bg-[#151e30] cursor-pointer">
          <td
            className={`whitespace-nowrap px-6 py-6 text-gray-400 dark:text-gray-300`}
          >
            <span
              title="Edit Item"
              className="text-center hover:text-slate-500 cursor-pointer"
              onClick={handleEdit}
            >
              <SlOptionsVertical size={19} />
            </span>

          </td>
          <td
            className={`sm:flex gap-4 whitespace-nowrap px-3 py-6 font-medium text-gray-900 dark:text-gray-300`}
          >
          ...
          <td className={`whitespace-pre-wrap  px-4 py-4  text-gray-900 dark:text-gray-300`}>
          ...
          <td className={`whitespace-nowrap px-4 py-4  text-gray-900 dark:text-gray-300`}>
          ...
          <td className={`whitespace-nowrap px-4 py-4 text-base  text-gray-900 dark:text-gray-300 `}>
            {item.category}
          </td>

          <td className={`whitespace-nowrap px-4 py-4 font-medium text-gray-600 dark:text-gray-500 `}>
            <span
